 ...
 * 
 */
@WebServiceClient(name = "UserWebService", targetNamespace = "http://cb.ukrpay.net/common/ws", wsdlLocation = "http://10.1.15.19:7001/backend/common/api.userapi/?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERWEBSERVICE_QNAME = new QName("http://cb.ukrpay.net/common/ws", "UserWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://10.1.15.19:7001/backend/common/api.userapi/?wsdl");
     ...
     */
    @WebEndpoint(name = "UserWebServiceSOAPHttpPort")
    public UserWebService getUserWebServiceSOAPHttpPort() {
        return super.getPort(new QName("http://cb.ukrpay.net/common/ws", "UserWebServiceSOAPHttpPort"), UserWebService.class);
    }
     ...
     */
    @WebEndpoint(name = "UserWebServiceSOAPHttpPort")
    public UserWebService getUserWebServiceSOAPHttpPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cb.ukrpay.net/common/ws", "UserWebServiceSOAPHttpPort"), UserWebService.class, features);
    }
